...
import com.github.ragudos.kompeter.app.desktop.components.panel.ImagePanel;
...
public class ProductList implements SceneComponent {
    ...
    private final JPanel view = new JPanel(
            new MigLayout("insets 0, flowy, gapy 16px", "[grow, fill, center]", "[grow 0][grow, fill]"));
    ...
    private SearchData prevSearchData = null;
    ...
    private void createItemCard(InventoryMetadataDto item) {
        ...
        JPanel contentContainer = new JPanel(new MigLayout("insets 0, gapy 9px, flowy", "[grow]", "[][][]push[]"));
        ...
        brand.putClientProperty(FlatClientProperties.STYLE_CLASS, "h5");
    ...
    public void searchItems(SearchData searchData) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            ArrayList<InventoryMetadataDto> filteredItems = new ArrayList<>(items.get().stream().filter((item) -> {
                ...
                return itemNameSimilarity >= THRESHOLD &&
                        item.categoryName().contains(searchData.searchCategory().toLowerCase()) &&
                        item.brandName().equals(searchData.searchBrand().toLowerCase());
    ...
    public void initialize() {
        ...
        itemsContainerScroller.getVerticalScrollBar().putClientProperty(FlatClientProperties.STYLE, "" +
                ...
                "thumbInsets:0,0,0,0;" +
                "width:5;");
        itemsContainerScroller.setBorder(BorderFactory.createEmptyBorder());
        ...
        executorService.submit(() -> {
            try {
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    ResponsiveLayout layout = ((ResponsiveLayout) itemsContainer.getLayout());
                    layout.setJustifyContent(JustifyContent.CENTER);
                    itemsContainer.add(new ErrorPanel());
        ...
        itemsContainer.add(new JLabel("Loading..."));
