...
public class MainFooter implements SceneComponent {
	...
	public void initialize() {
		...
		JPanel container = new JPanel(new MigLayout("gapx 10px,insets 3 n 3 n, al trailing center, height 32!",
				"[]push[]push[][][]", "fill"));
		...
		appVersionJLabel.setIcon(AssetManager.getOrLoadIcon("git-commit-horizontal.svg", 1f, "color.muted"));
