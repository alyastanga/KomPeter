    ...
    public static class HomeScenes {
        ...
        public static final class PointOfSaleScenes {
            public static final String POINT_OF_SALE_SCENE =
                    HOME_SCENE + ParsedSceneName.SEPARATOR + PointOfSaleScene.SCENE_NAME;
            public static final String SHOP_SCENE =
                    POINT_OF_SALE_SCENE + ParsedSceneName.SEPARATOR + ShopScene.SCENE_NAME;
            public static final String CHECKOUT_SCENE =
                    POINT_OF_SALE_SCENE + ParsedSceneName.SEPARATOR + CheckoutScene.SCENE_NAME;
        }

        public static final class ProfileScenes {
            public static final String PROFILE_SCENE =
                    HOME_SCENE + ParsedSceneName.SEPARATOR + ProfileScene.SCENE_NAME;
            public static final String READ_PROFILE_SCENE =
                    PROFILE_SCENE + ParsedSceneName.SEPARATOR + ReadProfileScene.SCENE_NAME;
            public static final String EDIT_PROFILE_SCENE =
                    PROFILE_SCENE + ParsedSceneName.SEPARATOR + EditProfileScene.SCENE_NAME;
        }

        public static final class InventoryScenes {
            public static final String INVENTORY_SCENE =
                    HOME_SCENE + ParsedSceneName.SEPARATOR + InventoryScene.SCENE_NAME;
            public static final String PRODUCT_LIST_SCENE =
                    INVENTORY_SCENE + ParsedSceneName.SEPARATOR + ProductListScene.SCENE_NAME;
        }

        public static final class MonitoringScenes {
            public static final String MONITORING_SCENE =
                    HOME_SCENE + ParsedSceneName.SEPARATOR + MonitoringScene.SCENE_NAME;
            public static final String OVERVIEW_SCENE =
                    MONITORING_SCENE + ParsedSceneName.SEPARATOR + MonitoringOverviewScene.SCENE_NAME;
        }

        public static final class SettingsScenes {
            public static final String SETTINGS_SCENE =
                    HOME_SCENE + ParsedSceneName.SEPARATOR + SettingsScene.SCENE_NAME;
            public static final String MAIN_SETTINGS_SCENE =
                    SETTINGS_SCENE + ParsedSceneName.SEPARATOR + MainSettingsScene.SCENE_NAME;
        }
    }
}
