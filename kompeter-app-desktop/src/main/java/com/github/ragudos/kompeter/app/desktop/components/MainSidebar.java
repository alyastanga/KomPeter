...
public class MainSidebar implements SceneComponent {
	...
	private void createLogisticsOfficerSidebar() {
		JButton inventoryButton = ButtonFactory.createButton("Inventory", "package.svg",
				SceneNames.HomeScenes.InventoryScenes.INVENTORY_SCENE, "ghost");
	...
	private void createPurchasingOfficerSidebar() {
		JButton inventoryButton = ButtonFactory.createButton("Inventory", "package.svg",
				SceneNames.HomeScenes.InventoryScenes.INVENTORY_SCENE, "ghost");
		JButton monitoringButton = ButtonFactory.createButton("Monitoring", "chart-no-axes-combined.svg",
	...
	private void createClerkSidebar() {
		JButton pointOfSaleButton = ButtonFactory.createButton("Point Of Sale", "boxes.svg",
	...
	public void initialize() {
		...
		JButton profileButton = ButtonFactory.createButton("Profile", "user-circle.svg",
				SceneNames.HomeScenes.ProfileScenes.PROFILE_SCENE, "ghost");
