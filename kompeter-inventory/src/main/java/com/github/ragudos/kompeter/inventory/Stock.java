...
public interface Stock {
    ...
    int setItemStocks(int _itemId, int _itemBrandId, BigDecimal _unitPrice, @Nullable int min_quantity)
    ...
    int updateItemStockStorageLocationQtyById(int itemStockId, int storageLocId, int qty) throws InventoryException;
