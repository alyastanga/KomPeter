...
public class StockService implements Stock {
    ...
    @Override
    public void setStockLocation(int _itemStockId, int _storageLocId, int qty) throws InventoryException {
        try {
            sqliteItemStockStorageLocationDao.setItemStockStorageLocation(_itemStockId, _storageLocId, qty);
    ...
    */
    @Override
    public void addRestock(int qtyAdded, int itemStockId, int storageLocationId) throws InventoryException {
        try {
            ...
            sqliteItemStockStorageLocationDao.updateItemStockQuantity(qtyAfter, itemStockId, storageLocationId); 
    ...
    @Override
    public void setItemStocks(int _itemId, int _itemBrandId, BigDecimal _unitPrice, int min_quantity) throws InventoryException {
        try {
