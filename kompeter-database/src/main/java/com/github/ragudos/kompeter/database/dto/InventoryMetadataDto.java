...
public record InventoryMetadataDto (
        ...
        @Range(from = 0, to = Integer.MAX_VALUE) int _itemStockId, //hide this shit na lang sa table, necessarry lang sya if i-edit yung price
        @Range(from = 0, to = Integer.MAX_VALUE) int _stockLocationId, // hide this shit also, necessarry if i-edit lang ang yung location ng stock
