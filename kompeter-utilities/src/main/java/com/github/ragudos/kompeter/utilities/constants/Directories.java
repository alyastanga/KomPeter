...
public final class Directories {
	...
	/**
	 * The directory where the application is installed. This is the directory where
	...
	static {
		if (SystemInfo.isWindows) {
			...
			CONFIG_DIRECTORY = APP_DIRECTORY + File.separator + Metadata.APP_TITLE + File.separator + "config";
			LOGS_DIRECTORY = APP_DIRECTORY + File.separator + Metadata.APP_TITLE + File.separator + "logs";
		} else if (SystemInfo.isLinux) {
			APP_DATA_DIRECTORY = SystemInfo.USER_HOME + File.separator + ".local";
			APP_DIRECTORY = APP_DATA_DIRECTORY + File.separator + "share" + File.separator + Metadata.APP_TITLE;
			CONFIG_DIRECTORY = APP_DATA_DIRECTORY + File.separator + "state" + File.separator + Metadata.APP_TITLE
					+ File.separator + "config";
			LOGS_DIRECTORY = APP_DATA_DIRECTORY + File.separator + "state" + File.separator + Metadata.APP_TITLE
					+ File.separator + "logs";
		} else if (SystemInfo.isMac) {
			APP_DATA_DIRECTORY = SystemInfo.USER_HOME + File.separator + "Library";
			APP_DIRECTORY = APP_DATA_DIRECTORY + File.separator + "Application Support" + File.separator
					+ Metadata.APP_TITLE;
			;
			CONFIG_DIRECTORY = APP_DATA_DIRECTORY + File.separator + "Preferences" + File.separator + Metadata.APP_TITLE
					+ File.separator + "config";
			LOGS_DIRECTORY = APP_DATA_DIRECTORY + File.separator + "Preferences" + File.separator + Metadata.APP_TITLE
					+ File.separator + "logs";
		} else {
